...
ALLOWED_HOSTS = config(
    "ALLOWED_HOSTS",
    default="loveyou.fly.dev",
    cast=Csv(),
)

CSRF_TRUSTED_ORIGINS = config(
    "CSRF_TRUSTED_ORIGINS",
    default="https://loveyou.fly.dev",
    cast=Csv(),
)
...
MIDDLEWARE = [
    ...
    "loveyou.core.middlewares.DjavueApiErrorHandlingMiddleware",
]
...
ROOT_URLCONF = "loveyou.loveyou.urls"
...
WSGI_APPLICATION = "loveyou.loveyou.wsgi.application"
...
#             'filename': os.getenv('DJANGO_LOG_FILE', './loveyou.log'),
#             'formatter': 'simple'
#         },
#     },
#     'loggers': {
